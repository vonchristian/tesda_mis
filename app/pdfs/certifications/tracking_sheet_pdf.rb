module Certifications 
  class TrackingSheetPdf < Prawn::Document
    ...
    def table_data
      move_down 5
      [["LAST NAME", "FIRST NAME", "MI", "CLN", "CERTIFICATE #", "QUALIFICATION/COMPETENCY", "DATE OF ASSESSMENT", "DATE OF RECEIPT OF CARS BY THE PO", "DATE OF PRINTING OF NC/COC", "SIGNATURE OF CANDIDATE", "DATE OF CLAIMED", "ISSUED BY"]] +
